...
class BST:
    ...
    def _rank(self, value, node):
        ...
        if _cmp < 0:
            return self._rank(value, node.left)
        elif _cmp > 0:
            return 1 + self._size(node.left) + self._rank(value, node.right)
        else:
    ...
    def predecessor(self, value):
        """
        Returns the largest key in the BST less than or equal to value ie "floor."
    ...
    def successor(self, value):
        """
        Returns the smallest key in the BST greater than or equal to value ie "ceiling."
    ...
    def is_bst(self):
        def _is_bst(root, min_value, max_value):
            ...
            if min_value < root.value < max_value \
                    and _is_bst(root.left, min_value, root.value) \
                    and _is_bst(root.right, root.value, max_value):
                return True
            else:
                return False
